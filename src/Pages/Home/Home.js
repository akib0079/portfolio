            ...
            <div className="sectionInner grid lg:grid-cols-2 items-center gap-4">
                <div className="info">
                    ...
                    <div className="flex gap-5">
                        <button className="mainBtn mt-2">Lets Chat! <i className='bx bxs-conversation' ></i></button>
                    </div>
                    {/* counters */}
                    <div className="grid lg:grid-cols-2 p-6 counters justify-center lg:justify-start" data-aos="flip-up" data-aos-duration="1100">
                        ...
                        <div className="counter flex items-center counter2nd">
